-- =====
-- Module : cadence / jasper / 2024.03p002
-- Generated by: gen_module.py 2025-09-15 05:15:15
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2024.03p002"
local tool        = "JASPER"        -- cad_root vendor/tool path
local module_name = "jasper"      -- exposed module name (folder under module_root)
