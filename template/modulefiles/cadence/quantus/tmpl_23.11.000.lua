-- =====
-- Module : cadence / quantus / 23.11.000
-- Generated by: gen_module.py 2025-09-15 05:15:41
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "23.11.000"
local tool        = "QUANTUS"        -- cad_root vendor/tool path
local module_name = "quantus"      -- exposed module name (folder under module_root)
