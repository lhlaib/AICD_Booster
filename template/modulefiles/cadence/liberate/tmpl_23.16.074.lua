-- =====
-- Module : cadence / liberate / 23.16.074
-- Generated by: gen_module.py 2025-09-15 05:16:35
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "23.16.074"
local tool        = "LIBERATE"        -- cad_root vendor/tool path
local module_name = "liberate"      -- exposed module name (folder under module_root)
...
local bins = {
  "tools.lnx86/bin",
  "tools.lnx86/bin/64bit",
}
local libs = {
  "tools.lnx86/lib",
  "tools.lnx86/lib/64bit",
}
local manuals = {
...
setenv("LIBERATE_HOME", root)

-- ========= Aliases =========
set_alias("liberate", "liberate --trio")
set_alias("liberate_lv", "liberate_lv --trio")
