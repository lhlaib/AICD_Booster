-- =====
-- Module : cadence / pegasus / 21.20.000
-- Generated by: gen_module.py 2025-09-15 05:17:28
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "21.20.000"
local tool        = "PEGASUS"        -- cad_root vendor/tool path
local module_name = "pegasus"      -- exposed module name (folder under module_root)
