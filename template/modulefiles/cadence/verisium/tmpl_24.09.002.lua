-- =====
-- Module : cadence / verisium / 24.09.002
-- Generated by: gen_module.py 2025-09-15 05:16:57
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "24.09.002"
local tool        = "VERISIUM"        -- cad_root vendor/tool path
local module_name = "verisium"      -- exposed module name (folder under module_root)
...
setenv("VERISIUM_HOME", root)
setenv("VERISIUM_DEBUG_ROOT", root)
