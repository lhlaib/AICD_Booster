-- =====
-- Module : cadence / stratus / 24.02.003
-- Generated by: gen_module.py 2025-09-15 05:17:36
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "24.02.003"
local tool        = "STRATUS"        -- cad_root vendor/tool path
local module_name = "stratus"      -- exposed module name (folder under module_root)
