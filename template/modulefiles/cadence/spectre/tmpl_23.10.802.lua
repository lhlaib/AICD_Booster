-- =====
-- Module : cadence / spectre / 23.10.802
-- Generated by: gen_module.py 2025-09-15 05:16:47
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "23.10.802"
local tool        = "SPECTRE"        -- cad_root vendor/tool path
local module_name = "spectre"      -- exposed module name (folder under module_root)
