-- =====
-- Module : cadence / tempus / 23.14.000
-- Generated by: gen_module.py 2025-09-15 05:23:10
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "23.14.000"
local tool        = "SSV"        -- cad_root vendor/tool path
local module_name = "tempus"      -- exposed module name (folder under module_root)
