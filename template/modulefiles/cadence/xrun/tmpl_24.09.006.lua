-- =====
-- Module : cadence / xrun / 24.09.006
-- Generated by: gen_module.py 2025-09-15 05:17:53
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "24.09.006"
local tool        = "XCELIUM"        -- cad_root vendor/tool path
local module_name = "xrun"      -- exposed module name (folder under module_root)
