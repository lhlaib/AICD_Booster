-- =====
-- Module : cadence / vmanager / 24.03.004
-- Generated by: gen_module.py 2025-09-15 05:17:07
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "24.03.004"
local tool        = "VMANAGER"        -- cad_root vendor/tool path
local module_name = "vmanager"      -- exposed module name (folder under module_root)
...
setenv("VMANAGER_HOME", root)
setenv("VMANAGER_DEBUG_ROOT", root)
