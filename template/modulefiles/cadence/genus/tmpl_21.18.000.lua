-- =====
-- Module : cadence / genus / 21.18.000
-- Generated by: gen_module.py 2025-09-15 05:15:05
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "21.18.000"
local tool        = "GENUS"        -- cad_root vendor/tool path
local module_name = "genus"      -- exposed module name (folder under module_root)
