-- =====
-- Module : synopsys / customexplorer / 2025.06-2
-- Generated by: gen_module.py 2025-09-15 05:19:01
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "customexplorer"        -- cad_root vendor/tool path
local module_name = "customexplorer"      -- exposed module name (folder under module_root)
...
setenv("CUSTOMEXPLORER_HOME", root)
