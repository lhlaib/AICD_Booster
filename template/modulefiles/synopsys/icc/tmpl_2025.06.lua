-- =====
-- Module : synopsys / icc / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:21:11
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "icc"        -- cad_root vendor/tool path
local module_name = "icc"      -- exposed module name (folder under module_root)
...
do
  local dir = "/" .. cad_root .. "/synopsys/verdi/2022.06/platform/linux64/lib/Qt"
  if (isDir(dir)) then
...
setenv("ICC_HOME", root)
setenv("XLOCALEDIR", root .. "/etc/locale")
