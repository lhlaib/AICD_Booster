-- =====
-- Module : synopsys / verdi / 2022.06
-- Generated by: gen_module.py 2025-09-15 05:20:14
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2022.06"
local tool        = "verdi"        -- cad_root vendor/tool path
local module_name = "verdi"      -- exposed module name (folder under module_root)
local vendor      = "synopsys"
...
local libs = {
  ...
  "share/PLI/lib/LINUX64",
  "etc/lib/libstdc++/LINUX64",
}
local manuals = {
...
setenv("SYNOPSYS", "/usr/cad/synopsys")
setenv("VERDI_HOME", root)

-- ========= Aliases =========
set_alias("debussy", "debussy -licverdi")
set_alias("Debussy", "Debussy -licverdi")
...
if (mode() == "load") then
  ...
  LmodMessage(bar)
  LmodMessage(string.format("[MOD] Loaded %s tool (VCS ver): %s/%s", vendor, module_name_colored, version_colored))
