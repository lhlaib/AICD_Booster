-- =====
-- Module : synopsys / laker / 2024.12-2
-- Generated by: gen_module.py 2025-09-15 05:20:36
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2024.12-2"
local tool        = "laker"        -- cad_root vendor/tool path
local module_name = "laker"      -- exposed module name (folder under module_root)
...
setenv("LAKER_OA_HOME", root)
setenv("Laker_TCL_L3", "1")
setenv("Laker_TCL_ToolBox", "1")
