-- =====
-- Module : synopsys / hspice / 2025.06-1
-- Generated by: gen_module.py 2025-09-15 05:20:30
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2025.06-1"
local tool        = "hspice"        -- cad_root vendor/tool path
local module_name = "hspice"      -- exposed module name (folder under module_root)
...
setenv("HSPICE_HOME", root)

source_sh("csh", root .. "/hspice/bin/cshrc.meta")
