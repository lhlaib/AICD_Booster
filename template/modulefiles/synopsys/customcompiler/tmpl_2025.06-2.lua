-- =====
-- Module : synopsys / customcompiler / 2025.06-2
-- Generated by: gen_module.py 2025-09-15 05:18:01
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2025.06-2"
local tool        = "customcompiler"        -- cad_root vendor/tool path
local module_name = "customcompiler"      -- exposed module name (folder under module_root)
...
setenv("CUSTOMCOMPILER_HOME", root)
setenv("SYNOPSYS_CUSTOM_LEGACY_SIMENV", "0")

-- ========= Aliases =========
set_alias("pw", "primewave")
