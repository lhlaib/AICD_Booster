-- =====
-- Module : synopsys / starrc / 2019.12-sp5-3
-- Generated by: gen_module.py 2025-09-16 07:02:21
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2019.12-sp5-3"
local tool        = "star-rcxt"        -- cad_root vendor/tool path
local module_name = "starrc"      -- exposed module name (folder under module_root)
...
local libs = {
  "linux64_starrc/lib",
  "linux64_starrc/lib/shlib",
  "linux64_starrc/lib/shlib/qt/lib",
}
local manuals = {
  "starrc/man",
}
...
do
  local dir = "/" .. cad_root .. "/synopsys/primetime/2025.06/linux64/pt/shlib_python/"
  if (isDir(dir)) then
