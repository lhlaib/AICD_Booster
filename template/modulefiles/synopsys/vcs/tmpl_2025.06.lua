-- =====
-- Module : synopsys / vcs / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:18:49
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "vcs"        -- cad_root vendor/tool path
local module_name = "vcs"      -- exposed module name (folder under module_root)
...
do
  local dir = "/" .. cad_root .. "/synopsys/verdi/cur/share/PLI/VCS/LINUX64"
  if (isDir(dir)) then
...
setenv("VCS_HOME", root)
setenv("VCS_STATIC_HOME", root .. "/vcfca")
setenv("VCS_CC", "gcc")
