-- =====
-- Module : synopsys / customsim / 2025.06-1
-- Generated by: gen_module.py 2025-09-15 05:19:44
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "xa"        -- cad_root vendor/tool path
local module_name = "customsim"      -- exposed module name (folder under module_root)
