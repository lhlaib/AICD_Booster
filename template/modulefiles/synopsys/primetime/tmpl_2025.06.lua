-- =====
-- Module : synopsys / primetime / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:19:26
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "primetime"        -- cad_root vendor/tool path
local module_name = "primetime"      -- exposed module name (folder under module_root)
...
local bins = {
  "amd64/syn/bin",
  "primeclosure/cur/amd64/syn/bin",
}
local libs = {
...
setenv("PRIMETIME_HOME", root)

-- ========= Aliases =========
set_alias("pt", "primetime")
