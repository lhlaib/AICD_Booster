-- =====
-- Module : synopsys / formality / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:19:51
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "formality"        -- cad_root vendor/tool path
local module_name = "formality"      -- exposed module name (folder under module_root)
...
setenv("SYNOPSYS", root)
setenv("FORMALITY", root)
