-- =====
-- Module : synopsys / primesim / 2025.06-1
-- Generated by: gen_module.py 2025-09-15 05:18:42
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "primesim"        -- cad_root vendor/tool path
local module_name = "primesim"      -- exposed module name (folder under module_root)
