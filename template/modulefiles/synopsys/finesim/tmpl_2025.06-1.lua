-- =====
-- Module : synopsys / finesim / 2025.06-1
-- Generated by: gen_module.py 2025-09-15 05:19:09
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "finesim"        -- cad_root vendor/tool path
local module_name = "finesim"      -- exposed module name (folder under module_root)
