-- =====
-- Module : synopsys / tmax / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:21:25
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "tmax"        -- cad_root vendor/tool path
local module_name = "tmax"      -- exposed module name (folder under module_root)
...
local libs = {
  "testmax/cur/embedit/linux64/lib_cc",
}
local manuals = {
  "doc/syn/man",
}
...
setenv("SYNTHESIS_HOME", root)

-- ========= Aliases =========
set_alias("da", "design_analyzer")
set_alias("dv", "design_vision")
set_alias("pc", "psyn_gui")
