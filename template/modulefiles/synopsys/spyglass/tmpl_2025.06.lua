-- =====
-- Module : synopsys / spyglass / 2025.06
-- Generated by: gen_module.py 2025-09-15 05:20:06
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "spyglass"        -- cad_root vendor/tool path
local module_name = "spyglass"      -- exposed module name (folder under module_root)
