-- =====
-- Module : synopsys / icv / 2025.06-1
-- Generated by: gen_module.py 2025-09-15 05:19:59
-- Author: Lin-Hung Lai
-- =====
...
local tool        = "icvalidator"        -- cad_root vendor/tool path
local module_name = "icv"      -- exposed module name (folder under module_root)
...
setenv("ICV_HOME_DIR", root)
setenv("SYNOPSYS_SYSTYPE", root .. "/setup/GetENV")
