-- =====
-- Module : synopsys / dc / 2022.03
-- Generated by: gen_module.py 2025-09-15 05:20:22
-- Author: Lin-Hung Lai
-- =====
...
-- =======================================================
local version     = "2022.03"
local tool        = "synthesis"        -- cad_root vendor/tool path
local module_name = "dc"      -- exposed module name (folder under module_root)
