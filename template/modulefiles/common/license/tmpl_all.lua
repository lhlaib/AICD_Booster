help([[lshc license bundle]])
whatis("lshc license bundle")
-- 逐一追加（不覆蓋），Lmod 會自動去重
local items = {"1717@lshc","5280@lshc","26585@lshc", "1717@lstc","5280@lstc","26585@lstc", "1717@lstn","5280@lstn","26585@lstn"}
...
if (mode() == "load") then
  ...
  -- LmodMessage("[MOD] Loaded license/all: " .. table.concat(items, ":"))
  local yellow_license = colored("license/all", "1;32")  -- 33 = yellow
  LmodMessage(bar)
  LmodMessage("[MOD] Loaded license(lshc/lstc/lstn): " .. yellow_license)
